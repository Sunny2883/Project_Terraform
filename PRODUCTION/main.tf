...
module "vpc" {
  ...
  vpc_name = "VPC_main_prod"
}

module "security_group" {
  source = "../Security_group"
  vpc_id = module.vpc.vpc_id
  Security_group_name = "ecs-security-group_prod"
}
...
module "ecs" {
  source = "../AWS_ECS"
  cluster_name = "project_cluster_prod"
  family_name_task1 = "project-task-family_prod"
  family_name_task2 = "backend_task_family_prod"
  image_url = "730335487196.dkr.ecr.ap-south-1.amazonaws.com/project_repo:latest"
  min_capacity=1
  task_name="project_task_definition_prod"
  max_capacity = 1
  cpu = 1000
  memory = 1000
  backend_image_url = "730335487196.dkr.ecr.ap-south-1.amazonaws.com/project_repo_dotnet:latest"
  backend_task_name = "dotnet_app_prod"
  backend_cpu = 300
  backend_memory = 300
  backend_min_capacity = 1
  ecs_service1 = "ecs_service_prod"
  ecs_service2 = "backend_ecs_service_prod"
  target_group_arn = module.aws_lb.target_group_arn
}